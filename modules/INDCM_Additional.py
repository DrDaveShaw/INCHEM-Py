'''
INDCM and INCHEM-Py Additional reactions maintained by Shaw and Carslaw.
...
INDCM_RO2 = ["LINALAO2","LINALBO2","C7H15CO3","C8H17CO3","C9H19CO3","CH3CHOHO2"
             ,"OLECLO2","IPROCLPER","HYPROCLO2"]

INDCM_sums = [["OLEFIN","BUT1ENE+CBUT2ENE+TBUT2ENE+MEPROPENE+PENT1ENE+CPENT2ENE+\
